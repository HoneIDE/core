...
/**
 * HMAC-SHA256 signing using pure JS SHA-256 implementation.
 */
...
/** Pure JS SHA-256 producing hex digest. */
function sha256Hex(input: string): string {
  ...
  for (let i = 0; i < input.length; i++) data[i] = input.charCodeAt(i) & 0xff;
