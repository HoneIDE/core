...
export class OpenAIAdapter implements AIProviderAdapter {
  ...
  listModels(): AIModelInfo[] {
    return [
      ...
      { id: 'o3', name: 'o3', contextWindow: 200000, supportsTools: true, supportsStreaming: true, supportsVision: true },
      { id: 'o4-mini', name: 'o4-mini', contextWindow: 200000, supportsTools: true, supportsStreaming: true, supportsVision: true },
    ];
  }
